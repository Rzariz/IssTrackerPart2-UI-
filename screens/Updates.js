...
import { FlatList, Text, View, ImageBackground, Image, TouchableOpacity, SafeAreaView, StyleSheet, Platform, Alert, Linking , StatusBar} from 'react-native';
        ...
        if (item.type == "Article") {
            return (
                <TouchableOpacity style={styles.listContainer}
                    onPress={() =>
                        Linking.openURL(item.url).catch(err => console.error("Could not load image"))}>
